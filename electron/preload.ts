...
const api: StrataAPI = {
  ...
  renameSection: (notebook, oldSection, newSection) => ipcRenderer.invoke('rename-section', notebook, oldSection, newSection),
  reorderEntries: (updates) => ipcRenderer.invoke('reorder-entries', updates),
