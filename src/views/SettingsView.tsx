          ...
          <div className="settings-panel">
            ...
            <div className="settings-section">
              ...
              <SettingRow label="Default structure" description="Structure assigned to new notes">
                <select className="settings-select" value={prefs.defaultStructure} onChange={e => update({ defaultStructure: e.target.value })}>
              ...
              <SettingRow label="Default pressure" description="Pressure level assigned to new notes">
                <select className="settings-select" value={prefs.defaultPressure} onChange={e => update({ defaultPressure: e.target.value })}>
              ...
              <SettingRow label="Auto-save delay" description="Milliseconds before saving after typing stops">
                <select className="settings-select" value={prefs.autosaveInterval} onChange={e => update({ autosaveInterval: e.target.value })}>
              ...
              <SettingRow label="Default editor mode" description="Editor mode when opening a note">
                <select className="settings-select" value={prefs.editorModeDefault} onChange={e => update({ editorModeDefault: e.target.value as 'write' | 'split' | 'preview' })}>
          ...
          <div className="settings-panel">
            ...
            <div className="settings-section">
              ...
              <SettingRow label="Font family" description="Typeface used in the editor and preview">
                <select className="settings-select" value={prefs.fontFamily} onChange={e => update({ fontFamily: e.target.value })}>
              ...
              <SettingRow label="Font size" description="Base font size in pixels">
                <select className="settings-select" value={prefs.fontSize} onChange={e => update({ fontSize: e.target.value })}>
              ...
              <SettingRow label="Line height" description="Line spacing multiplier">
                <select className="settings-select" value={prefs.lineHeight} onChange={e => update({ lineHeight: e.target.value })}>
            ...
            <div className="settings-section">
              ...
              <SettingRow label="Tab size" description="Number of spaces per tab">
                <select className="settings-select" value={prefs.tabSize} onChange={e => update({ tabSize: e.target.value })}>
                  <option value="2">2 spaces</option>
                  <option value="4">4 spaces</option>
                </select>
              </SettingRow>
              <SettingToggle label="Word wrap" description="Wrap long lines instead of horizontal scrolling" checked={prefs.wordWrap} onChange={v => update({ wordWrap: v })} />
              <SettingToggle label="Line numbers" description="Show line numbers in the editor gutter" checked={prefs.showLineNumbers} onChange={v => update({ showLineNumbers: v })} />
              <SettingToggle label="Spell check" description="Enable browser spell checking in the editor" checked={prefs.spellCheck} onChange={v => update({ spellCheck: v })} />
            </div>
          ...
          <div className="settings-panel">
            ...
            <div className="settings-section">
              ...
              <div className="settings-theme-grid">
                <ThemeCard
                  ...
                  onSelect={() => update({ theme: 'nord-dark' })}
                />
                <ThemeCard
                  id="editorial-light"
                  ...
                  onSelect={() => update({ theme: 'editorial-light' })}
                />
                <ThemeCard
                  id="editorial-dark"
                  ...
                  onSelect={() => update({ theme: 'editorial-dark' })}
                />
              </div>
            </div>
            ...
            <div className="settings-section">
              ...
              <SettingRow label="Sidebar width" description="Width of the navigation sidebar in pixels">
                <select className="settings-select" value={prefs.sidebarWidth} onChange={e => update({ sidebarWidth: e.target.value })}>
              ...
              <SettingRow label="Note list width" description="Width of the note list panel in pixels">
                <select className="settings-select" value={prefs.notelistWidth} onChange={e => update({ notelistWidth: e.target.value })}>
              ...
              <SettingRow label="Editor max width" description="Maximum width of the editor content area">
                <select className="settings-select" value={prefs.editorMaxWidth} onChange={e => update({ editorMaxWidth: e.target.value })}>
